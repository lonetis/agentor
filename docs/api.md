...
**Tag groups (15):** Containers, Tmux, Apps, Port Mappings, Domain Mappings, Environments, Skills, AGENTS.md, Archived Workers, Logs, Updates, GitHub, Usage, Config, Health — plus an "Internal" tag for proxy/WebSocket relay routes.
